...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::ScheduledTime::Error::InvalidTime>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::HardwareIsolation::Error::IsolatedAlready>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Common::Error::TooManyResources>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Common::Error::ResourceNotFound>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Common::Error::Unavailable>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Common::Error::UnsupportedRequest>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Software::Version::Error::AlreadyExists>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Software::Version::Error::InvalidSignature>
{
    using type = xyz::openbmc_project::Software::Version::InvalidSignature;
};
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::User::Common::Error::GroupNameExists>
{
    using type = xyz::openbmc_project::User::Common::GroupNameExists;
};
...
namespace Common
{
namespace _GroupNameDoesNotExist
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::User::Common::Error::GroupNameDoesNotExist>
{
    using type = xyz::openbmc_project::User::Common::GroupNameDoesNotExist;
};
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Common::File::Error::Read>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::BIOSConfig::Common::Error::AttributeNotFound>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::BIOSConfig::Common::Error::AttributeReadOnly>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::BIOSConfig::Common::Error::InvalidCurrentPassword>
{
    using type = xyz::openbmc_project::BIOSConfig::Common::InvalidCurrentPassword;
};
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::BIOSConfig::Common::Error::PasswordNotSettable>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Logging::SEL::Error::Created>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Smbios::MDR_V2::Error::InvalidParameter>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Smbios::MDR_V2::Error::UpdateInProgress>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Smbios::MDR_V2::Error::InvalidId>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::State::SystemdTarget::Error::Failure>
{
...
{
    static constexpr auto L = level::ERR;
    using SYSTEMD_RESULT = xyz::openbmc_project::State::SystemdTarget::Failure::SYSTEMD_RESULT;
    using metadata_types = std::tuple<SYSTEMD_RESULT>;
};
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::State::Chassis::Error::PowerOnFailure>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::State::Chassis::Error::PowerOffFailure>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::State::Chassis::Error::PowerCycleFailure>
{
    using type = xyz::openbmc_project::State::Chassis::PowerCycleFailure;
};
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::State::Host::Error::HostStartFailure>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::State::Host::Error::HostMinStartFailure>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::State::Host::Error::HostShutdownFailure>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::State::Host::Error::HostStopFailure>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::State::Host::Error::HostRebootFailure>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::State::Shutdown::Power::Error::Regulator>
{
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::State::BMC::Error::MultiUserTargetFailure>
{
